...
export const LayoutToggle = ({ isVertical, onToggle }: LayoutToggleProps) => {
  return (
    <div className="inline-flex -space-x-px rounded-lg shadow-sm shadow-black/5 rtl:space-x-reverse">
      <Button
        className="rounded-r-none shadow-none first:rounded-s-lg focus-visible:z-10 h-10"
      ...
      <Button
        className="rounded-l-none shadow-none last:rounded-e-lg focus-visible:z-10 h-10"
        variant={isVertical ? "default" : "outline"}
        size="icon"
