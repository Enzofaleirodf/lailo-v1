      ...
      <CardContent className="p-0 space-y-2">
          ...
          <div className="flex flex-col gap-3 flex-1 min-w-0">
            ...
            <div className="flex items-center justify-between">
              ...
              <Badge className="bg-blue-light800 text-basewhite px-1 py-0 rounded hover:bg-blue-light800/90 bg-rose-600 flex-shrink-0">
                <span className="font-urbanist font-medium text-sm md:text-xs">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-1">
            <Badge variant="outline" className="text-gray-900 font-normal text-[12px] md:text-[10px] px-1 rounded border-none bg-rose-50 py-[2px]">
              <span className="font-urbanist font-medium text-[14px] md:text-[12px]">{vehicleData.badges[1].charAt(0)}</span>
              <span className="font-roboto font-medium text-[14px] md:text-[12px]">ª</span>
              <span className="font-urbanist font-medium text-[14px] md:text-[12px]"> Praça</span>
            </Badge>

            <Badge variant="outline" className="text-gray-900 font-medium text-[12px] md:text-[10px] px-1 py-0.5 rounded border-none bg-rose-50">
              <span className="font-urbanist text-[14px] md:text-[12px]">{vehicleData.badges[0]}</span>
            </Badge>
          </div>

          <div className="flex items-center gap-1">
            <Calendar className="w-3 h-3 text-gray-500" />
            <span className="font-urbanist text-gray-500 text-[14px] md:text-[12px] px-0.5 py-[2px] font-medium">
              {vehicleData.date}
            </span>
