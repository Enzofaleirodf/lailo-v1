...
export const TopBarFilters = ({
  ...
  return (
    <div className="flex items-center gap-3 min-w-0">
      {/* Container com largura fixa para evitar movimento */}
      <div className="flex items-start gap-3 min-w-[920px]">
        ...
        {getFilterCount() > 0 && (
          <div className="flex-shrink-0 flex items-center w-[140px]">
            <div 
              className="px-3 py-2 bg-blue-100 text-blue-700 rounded-full text-sm font-medium whitespace-nowrap" 
              style={{
