  ...
  if (itemType === 'vehicle') {
    ...
    return (
      <div>
        ...
        <div className="flex items-center gap-2 text-sm md:text-sm text-muted-foreground mt-1">
  ...
  return (
    <div>
      <div className="flex items-center gap-2">
        ...
        <span className="w-1 h-1 bg-gray-300 rounded-full flex-shrink-0" />
        <span className="text-sm md:text-sm text-muted-foreground flex-shrink-0" data-no-link="true">
          {property.area}
        </span>
      </div>
      <div className="flex items-center gap-2 text-sm md:text-sm text-muted-foreground mt-1">
