        ...
        <div className="max-w-[1440px] mx-auto w-full relative min-h-screen bg-white">
          ...
          <main className="ml-12 min-h-screen flex flex-col">
            <div className="flex-1 px-6 py-8">
              ...
              {/* Accordion com tabelas - Container com largura fixa */}
                                ...
                                {junta && (
                                  ...
                                  >
                                    <Button
                                      variant="outline"
                                      size="sm"
                                      className="gap-2 text-xs h-8 pointer-events-none"
                                    >
                                      {junta.sigla}
                              ...
                              <table className="w-full min-w-[1140px] border-collapse">
                                <thead className="bg-gray-50">
                                  <tr className="h-12">
                                    ...
                                    <th className="w-[240px] px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                      Website
                                    </th>
                                    <th className="w-[200px] px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                      Leilões Ativos
      ...
      <div className="block md:hidden">
        <div className="w-full min-h-screen bg-white">
          ...
          <div className="fixed bottom-0 left-0 right-0 z-50">
            {/* Placeholder para bottom navigation */}
          </div>
        </div>
      </div>
    </div>
...
export default LeiloeirosPadronizada;
